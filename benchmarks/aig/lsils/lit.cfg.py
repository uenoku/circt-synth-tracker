"""
Configuration file for lsils AIG benchmark suite using lit.
...
# excludes: Exclude the lsils benchmarks submodule directory itself
config.excludes = ['benchmarks']
...
relative_path = Path(__file__).parent.relative_to(benchmarks_root)  # Gets aig/lsils
